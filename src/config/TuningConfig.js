...
export const TUNING = {
    ...
    world: {
        gridCell:     32,   // клетка debug-сетки / резервирования зданий
        obstacleCell: 48,   // клетка пространственного индекса препятствий
        spawnStep:    24,   // шаг поиска безопасной точки спавна
        spawnMaxR:    3000, // макс. радиус поиска спавна
        freeSpotMaxR: 500,  // макс. радиус поиска свободного места после телепорта
    },
    ...
    player: {
        ...
        speed: 70,
        blockWater: true,
        // Хитбокс «ног»: frame 16×24, origin (0.5, 1)
        bodyW: 10, bodyH: 5, bodyOffsetX: 3, bodyOffsetY: 18,
    },
    ...
    audio: {
        ...
        indoor: {
            ...
            volume: 0.30,
            fadeSec: 1.2,
            roomTone: { freq: 120, q: 0.6, gain: 0.5 },
            creakMinMs: 4000,
            creakMaxMs: 11000,
        },
        ...
        footstep: {
            enabled: true,
            volume: 0.16,
            indoorEcho: 0.55,   // доля «эха» в помещении
        },
    ...
    house: {
        zoom: 2.8,           // крупнее уличного — «массивный, давящий» дом
        wallHeightPx: 22,    // высота стен (cutaway-грани)
        cutawayAlpha: 0.16,  // прозрачность передней (ближней) стены
        light: {
            warmAlpha: 0.04,       // тёплый глобальный тон
            vignetteAlpha: 0.30,   // затемнение краёв экрана
            windowGlowAlpha: 0.22, // световые пятна под окнами
        },
    },
