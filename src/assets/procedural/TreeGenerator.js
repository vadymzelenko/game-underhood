...
import { PALETTE, hexToRgb, lerp, fbm, vnoise, hash2 } from './utils.js';
...
export class TreeGenerator extends BaseGen {
    ...
    renderCanopy() {
        ...
        // Крона — та же SDF-заливка, что у кустов/мха (см. blobMass.js).
        drawBlobMass(this.ctx, this.width, this.height, this.clusters, this.scheme, this.seed, 0.08);
    }
}