...
export class InteriorScene extends Phaser.Scene {
    ...
    init(data) {
        ...
        const cfg = this.buildingId ? getBuildingById(this.buildingId) : null;
        this.buildingCfg = cfg;

        const I = cfg?.interior ?? { title: 'КОМНАТА', roomW: 320, roomH: 200 };
        this.roomW = I.roomW;
        this.roomH = I.roomH;
        this.roomTitle = I.title;
    }
    ...
    create() {
        ...
        const sideW = Math.max(60, W * 0.30);
        g.fillStyle(P.DARK_BROWN, 1);
        g.fillRect(10,           H * 0.30, sideW, 8);
        g.fillRect(W - 10 - sideW, H * 0.30, sideW, 8);
        g.fillRect(10,           H * 0.65, sideW, 8);
        g.fillRect(W - 10 - sideW, H * 0.65, sideW, 8);
        ...
        this.add.text(W / 2, 22, this.roomTitle, {
